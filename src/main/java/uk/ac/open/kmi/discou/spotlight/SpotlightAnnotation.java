...
public class SpotlightAnnotation {
       ...
       {
    	  this.uri=uri; this.support=support; this.types=types; this.surfaceForm=sF; this.offset=offset; this.similarity=sim; this.secondRankPct=sRP; this.confidence=c;
       }
       ...
       private void parseDomNode(Node xml)
       {
               ...
               offset = (nm.getNamedItem("offset") != null) ?
               ...
               types = (nm.getNamedItem("types") != null) ?
                       new ArrayList<String>(Arrays.asList(nm.getNamedItem("types").getTextContent().split(","))) : null;
       }
